const locationsflag = [
    ...
    { pays: 'Suede', drapeau: "./flags/Suede.webp" },
    { pays: 'Slovenie', drapeau: "./flags/Slovenie.webp" },
    { pays: 'Slovaquie', drapeau: "./flags/Slovaquie.webp" },
    { pays: 'Roumanie', drapeau: "./flags/Roumanie.webp" },
    { pays: 'Tchequie', drapeau: "./flags/Tchequie.webp" },
    { pays: 'Portugal', drapeau: "./flags/Portugal.webp" },
    { pays: 'Pologne', drapeau: "./flags/Pologne.webp" },
    { pays: 'Pays-Bas', drapeau: "./flags/Pays-Bas.webp" },
    { pays: 'Malte', drapeau: "./flags/Malte.webp" },
    { pays: 'Luxembourg', drapeau: "./flags/Luxembourg.webp" },
    { pays: 'Lituanie', drapeau: "./flags/Lituanie.webp" },
    { pays: 'Lettonie', drapeau: "./flags/Lettonie.webp" },
    { pays: 'Italie', drapeau: "./flags/Italie.webp" },
    { pays: 'Irlande', drapeau: "./flags/Irlande.webp" },
    { pays: 'Hongrie', drapeau: "./flags/Hongrie.webp" },
    { pays: 'Grece', drapeau: "./flags/Grece.webp" },
    { pays: 'France', drapeau: "./flags/France.webp" },
    { pays: 'Finlande', drapeau: "./flags/Finlande.webp" },
    { pays: 'Estonie', drapeau: "./flags/Estonie.webp" },
    { pays: 'Espagne', drapeau: "./flags/Espagne.webp" },
    { pays: 'Danemark', drapeau: "./flags/Danemark.webp" },
    { pays: 'Croatie', drapeau: "./flags/Croatie.webp" },
    { pays: 'Bulgarie', drapeau: "./flags/Bulgarie.webp" },
    { pays: 'Belgique', drapeau: "./flags/Belgique.webp" },
    { pays: 'Autriche', drapeau: "./flags/Autriche.webp" },
    { pays: 'Allemagne', drapeau: "./flags/Allemagne.webp" }
];
